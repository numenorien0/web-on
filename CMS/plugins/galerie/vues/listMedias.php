...
-->
		...
		<div class='listMedia colonneGauche col-sm-12 col-lg-12 col-lg-offset-0'>
			<div class='col-sm-12 cadre'>
			<h3>Liste des albums Photos</h3>
				<div class='btnAdd'>	
					<a class='createPage' href='<?=$_GET['tools']?>&page=addMedias&type=photo'>+ Ajouter un nouvel album</a>
				</div>
				<?php
					$medias->listAllPhoto();
				?>
