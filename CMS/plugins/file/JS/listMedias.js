$(function(){
	$('.child, .edit').click(function(){
		window.location.href = 'outils.php?tools=file&page=editMedias&id='+$(this).attr('data-id');
	});

	$('.child2').click(function(){
		window.location.href = 'outils.php?tools=file&page=editMedias'+$(this).attr('data-id');
	});
