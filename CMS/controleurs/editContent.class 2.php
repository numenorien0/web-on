...
class editContent extends DB
{
	...
	public function display_text_fields()
	{
		...
		{
			//print_r($this->_description);
			$input .= "<div class='wysiwygContainer text-".$langue." col-sm-12 col-md-8'><textarea name='texte[".$langue."]' id='wysiwyg-".$langue."' class='tinyMCE' placeholder='Votre contenu'>".$this->_texte[$langue]."</textarea></div>";
		}		
	...
	public function afficher()
	{
		...
		echo "<div class='col-sm-12'><label for='template' class='col-md-2 labelLeft' >Template&nbsp&nbsp</label><select class='col-md-5' id='template'>$template</select></div>";
		echo "<div class='col-sm-12'><label for='texte' class='col-md-2 labelLeft'>Texte&nbsp&nbsp</label>".$this->display_text_fields()."</div>";
		echo "</div>";
